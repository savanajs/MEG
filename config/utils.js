...
// Base `src` path for mocks
module.exports.srcMocksPath = destPath =>
exports.srcPath('assets/mocks', destPath);

// Base `src` path for vendor files
module.exports.srcVendorPath = destPath =>
    exports.srcPath('assets/vendor', destPath);
    
// Base `src` path for sprite files
module.exports.srcSpritesPath = destPath =>
    exports.srcPath('assets/images/sprites', destPath);

// Base `sprites` path for images
module.exports.buildScriptsPath = destPath =>
	exports.buildPath('assets/images/sprites', destPath);
...
// Base `build` path for mocks
module.exports.buildMocksPath = destPath =>
	exports.buildPath('assets/mocks', destPath);
